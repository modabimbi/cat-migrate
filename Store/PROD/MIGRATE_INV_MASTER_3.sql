create or replace PROCEDURE MIGRATE_INV_MASTER_3 AS 
...
--  AND EXTERNAL_ID NOT LIKE 'OLD%';
  DBMS_OUTPUT.PUT_LINE( 'START MIGRATE_INV_MASTER_3 : ' || to_char(sysdate , 'dd/mm/yyyy hh24:mi'));
